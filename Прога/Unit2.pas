...
procedure TForm2.Button1Click(Sender: TObject); //Кнопка "Выход" и "Назад"
begin
if Button2.Visible = False and Button3.Visible = False and Button4.Visible = False then
  begin
    ...
    Label1.Caption:= 'ВИДЫ ПАТТЕРНОВ ПРОЕКТИРОВАНИЯ';
  end
  else
  begin
    Form1.Close;
...
procedure TForm2.Button2Click(Sender: TObject); //Изменение формы под список порождающих паттернов
begin
  ...
  Label1.Caption := 'ПОРОЖДАЮЩИЕ ПАТТЕРНЫ';
  Label2.Caption:='Абстрактная фабрика';
  Label5.Caption:='Строитель';
  Label8.Caption:='Фабричный метод';
  Label11.Caption:='Прототип';
  Label14.Caption:='Одиночка/singleton';
...
procedure TForm2.Button3Click(Sender: TObject); //Изменение формы под список структурных паттернов
begin
  Button1.Caption:= 'Назад';
  Button2.Visible:= False;
  Button3.Visible:= False;
  ...
  Label2.Caption:='Адаптер';
  Label5.Caption:='Мост';
  Label8.Caption:='Компоновщик';
  Label11.Caption:='Декоратор';
  Label14.Caption:='Фасад';
  Label17.Caption:='Легковес';
  Label20.Caption:='Заместитель';
  Label1.Caption := 'СТРУКТУРНЫЕ ПАТТЕРНЫ';
...
procedure TForm2.Button4Click(Sender: TObject); //Изменение формы под список поведенческих паттернов
begin
  Button1.Caption:= 'Назад';
  Button2.Visible:= False;
  Button3.Visible:= False;
  ...
  Label1.Caption := 'ПОВЕДЕНЧЕСКИЕ ПАТТЕРНЫ';
  Label2.Caption:='Цепочка обязанностей';
  Label5.Caption:='Команда';
  Label8.Caption:='Итератор';
  Label11.Caption:='Посредник';
  Label14.Caption:='Снимок';
  Label17.Caption:='Наблюдатель';
  Label20.Caption:='Состояние';
  Label23.Caption:='Стратегия';
  Label26.Caption:='Шаблонный метод';
  Label29.Caption:='Посетитель';
...
procedure TForm2.Button5Click(Sender: TObject); //Пример кода "наивный одиночка"
begin
  Form2.Hide;
  Form3.Show;
...
procedure TForm2.Button6Click(Sender: TObject); //пример кода "мультипоточный одиночка"
begin
  Form2.Hide;
  Form3.Show;
...
procedure TForm2.FormClose(Sender: TObject; var Action: TCloseAction); //закрытие
begin                                                                  //формы
Form1.Close;
end;


procedure TForm2.FormShow(Sender: TObject); //Плавное появление окна
begin
  Button1.Caption:= 'Выход';
  AnimateWindow(handle, 800, AW_CENTER or AW_BLEND);
end;

procedure TForm2.Label10Click(Sender: TObject); //примеры кодов "Итератор", "Фабричный метод" и "Компоновщик"
begin
  Form2.Hide;
  Form3.Show;
  if Label1.Caption = 'ПОРОЖДАЮЩИЕ ПАТТЕРНЫ' then
    Form3.Memo1.Lines.LoadFromFile('Content/CodeExample/Generative/factory-method.txt');
  if Label1.Caption = 'СТРУКТУРНЫЕ ПАТТЕРНЫ' then
    Form3.Memo1.Lines.LoadFromFile('Content/CodeExample/Structural/composite.txt');
  if Label1.Caption = 'ПОВЕДЕНЧЕСКИЕ ПАТТЕРНЫ' then
    Form3.Memo1.Lines.LoadFromFile('Content/CodeExample/Behavioral/Iterator.txt');
end;

procedure TForm2.Label12Click(Sender: TObject); //Описание "Прототип", "Декоратор" и "Посредник"
begin
  Form2.Hide;
  Form3.Show;
  if Label1.Caption = 'ПОРОЖДАЮЩИЕ ПАТТЕРНЫ' then
...
procedure TForm2.Label13Click(Sender: TObject); //примеры кодов "Прототип", "Декоратор" и "Посредник"
begin
  Form2.Hide;
  Form3.Show;
  if Label1.Caption = 'ПОРОЖДАЮЩИЕ ПАТТЕРНЫ' then
...
procedure TForm2.Label15Click(Sender: TObject); //Описание "Одиночки", "Фасад" и "Снимок"
begin
  Form2.Hide;
  Form3.Show;
  if Label1.Caption = 'ПОРОЖДАЮЩИЕ ПАТТЕРНЫ' then
...
procedure TForm2.Label16Click(Sender: TObject);   //Изменение формы под выбор вида "Одиночки"
begin                                             //примеры кодов "Фасад" и "Снимок"
  if Label1.Caption = 'ПОРОЖДАЮЩИЕ ПАТТЕРНЫ' then
  begin
...
procedure TForm2.Label18Click(Sender: TObject); //Описание "Легковес" и "Наблюдатель"
begin
  Form2.Hide;
  Form3.Show;
  if Label1.Caption = 'СТРУКТУРНЫЕ ПАТТЕРНЫ' then
...
procedure TForm2.Label19Click(Sender: TObject); //примеры кодов "Легковес" и "Наблюдатель"
begin
  Form2.Hide;
  Form3.Show;
  if Label1.Caption = 'СТРУКТУРНЫЕ ПАТТЕРНЫ' then
...
procedure TForm2.Label21Click(Sender: TObject); //Описание "Заместитель" и "Состояние"
begin
  Form2.Hide;
  Form3.Show;
  if Label1.Caption = 'СТРУКТУРНЫЕ ПАТТЕРНЫ' then
...
procedure TForm2.Label22Click(Sender: TObject); //примеры кодов "Заместитель" и "Состояние"
begin
  Form2.Hide;
  Form3.Show;
  if Label1.Caption = 'СТРУКТУРНЫЕ ПАТТЕРНЫ' then
...
procedure TForm2.Label24Click(Sender: TObject); //Описание "Стратегия"
begin
  Form2.Hide;
  Form3.Show;
...
procedure TForm2.Label25Click(Sender: TObject); //примеры кода "Стратегия"
begin
  Form2.Hide;
  Form3.Show;
...
procedure TForm2.Label27Click(Sender: TObject); //Описание "Шаблонный метод"
begin
  Form2.Hide;
  Form3.Show;
...
procedure TForm2.Label28Click(Sender: TObject); //примеры кода "Шаблонный метод"
begin
  Form2.Hide;
  Form3.Show;
...
procedure TForm2.Label30Click(Sender: TObject); //Описание "Посетитель"
begin
  Form2.Hide;
  Form3.Show;
...
procedure TForm2.Label31Click(Sender: TObject); //примеры кода "Посетитель"
begin
  Form2.Hide;
  Form3.Show;
...
procedure TForm2.Label3Click(Sender: TObject); //Описание "Абстрактная фабрика", "Адаптер" и "Цепочка обязанностей"
begin
  Form2.Hide;
  Form3.Show;
  if Label1.Caption = 'ПОРОЖДАЮЩИЕ ПАТТЕРНЫ' then
...
procedure TForm2.Label4Click(Sender: TObject); //примеры кодов "Абстрактная фабрика", "Адаптер" и "Цепочка обязанностей"
begin
  Form2.Hide;
  Form3.Show;
  if Label1.Caption = 'ПОРОЖДАЮЩИЕ ПАТТЕРНЫ' then
...
procedure TForm2.Label6Click(Sender: TObject); //Описание "Строитель", "Мост" и "Команда"
begin
  Form2.Hide;
  Form3.Show;
  if Label1.Caption = 'ПОРОЖДАЮЩИЕ ПАТТЕРНЫ' then
...
procedure TForm2.Label7Click(Sender: TObject); //примеры кодов "Строитель", "Мост" и "Команда"
begin
  Form2.Hide;
  Form3.Show;
  if Label1.Caption = 'ПОРОЖДАЮЩИЕ ПАТТЕРНЫ' then
...
procedure TForm2.Label9Click(Sender: TObject); //Описание "Фабричный метод", "Компоновщик" и "Итератор"
begin
  Form2.Hide;
  Form3.Show;
  if Label1.Caption = 'ПОРОЖДАЮЩИЕ ПАТТЕРНЫ' then
...
procedure TForm2.N2Click(Sender: TObject); // Вызов "О программе"
begin
  AboutBox.ShowModal;
end;

procedure TForm2.N3Click(Sender: TObject); //Вызов "Справка"
begin
