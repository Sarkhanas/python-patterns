...
procedure TForm1.FormHide(Sender: TObject); //Плавное скрытие формы и выключение музыки
begin
 AnimateWindow(handle, 1000, AW_BLEND or AW_HIDE);
 sndPlaySound(nil, SND_NODEFAULT or SND_ASYNC);
end;

procedure TForm1.FormShow(Sender: TObject); //Плавное появление формы и запуск музыки
begin
